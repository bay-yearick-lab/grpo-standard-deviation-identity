...
\label{tab:mass}
\small
\input{tables/generated_realdata_mass_table.tex}
\end{minipage}\hfill
...
\small
\input{tables/generated_realdata_degenerate_table.tex}
\end{minipage}
\end{table}
